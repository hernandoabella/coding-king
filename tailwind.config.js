...
export default {
  ...
  daisyui: {
    themes: ["light", "dark", "cupcake","bumblebee", "emerald", "valentine", "aqua", "retro", "coffee", "cyberpunk"], // Define whether to include all themes or specific themes (light, dark, cupcake)
