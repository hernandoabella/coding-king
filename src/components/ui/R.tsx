    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in R.',
        content: `# Declaring variables
name <- "Alice"
age <- 25
print(paste("Name:", name, ", Age:", age))`,
        output: `[1] "Name: Alice , Age: 25"`
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: 'Understand basic data types in R like numeric, character, and logical.',
        content: `# Data types
num <- 42
char <- "Hello"
bool <- TRUE
