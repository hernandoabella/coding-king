    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in Perl.',
...
print "Name: $name, Age: $age\\n";`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: 'Understand scalars, arrays, and hashes in Perl.',
        content: `# Scalars
my $num = 42;
my $string = "Hello";
...
print ref($num) ? "Reference" : "Scalar", "\\n";
print ref(@array) ? "Reference" : "Array", "\\n";
print ref(%hash) ? "Reference" : "Hash", "\\n";`,
        output: `Scalar
Array
Hash`
      },
      {
        id: 'subroutines',
        title: 'Subroutines',
        description: 'Learn how to define and call subroutines (functions) in Perl.',
        content: `sub greet {
  my ($name) = @_;
  print "Hello, $name!\\n";
}
