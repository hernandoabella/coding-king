    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in TypeScript.',
        content: `// Declaring Variables with Types
...
console.log(\`Name: \${name}, Age: \${age}\`);`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand TypeScript's data types like number, string, boolean, and object.",
        content: `let integer: number = 10;
let floating: number = 3.14;
let text: string = "TypeScript";
let flag: boolean = true;

console.log(typeof integer, typeof floating, typeof text, typeof flag);`,
        output: "number number string boolean"
      },
      {
        id: 'interfaces',
        title: 'Interfaces',
        description: 'Learn how to define and use interfaces in TypeScript.',
...
console.log(person);`,
      ...
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in TypeScript.',
        content: `const PI: number = 3.14159;
console.log(PI);`,
        output: "3.14159"
      }
    ],
...
const TypeScriptTutorial: React.FC = () => {
  const [activeSection, setActiveSection] = useState<Section>(tutorialData[0]);
  const [activeSubtopic, setActiveSubtopic] = useState<Subtopic>(tutorialData[0].subtopics[0]);
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto p-4 md:p-6 transition-all duration-300">
      {/* Sidebar */}
      <aside className={`w-full lg:w-80 p-5 rounded-2xl shadow-lg border overflow-y-auto h-[calc(50vh-2rem)] custom-scroll
