    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in Bash.',
...
echo "Name: $name, Age: $age"`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand basic Bash variable types and usage.",
        content: `# Bash treats variables as strings by default
integer=10
floating=3.14
string="Bash"
boolean=true

echo $integer $floating $string $boolean`,
        output: "10 3.14 Bash true"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Bash does not have true constants but you can use readonly variables.',
    ...
    <div className="flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto p-4 md:p-6 transition-all duration-300">
      ...
      <main className={`flex-1 p-6 rounded-2xl shadow-lg border overflow-y-auto max-h-[calc(100vh-8rem)] custom-scroll
        ...
        <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5 mb-6">
          <div
            className="bg-gradient-to-r from-green-500 via-lime-500 to-yellow-500 h-2.5 rounded-full transition-all duration-500 ease-out"
        ...
        >
          ...
          {/* Code block */}
          <div className={`border relative rounded-lg ${isDarkMode ? 'border-gray-700' : 'border-gray-200'} ${isGlowing ? 'ring-2 ring-green-500 shadow-xl' : 'hover:shadow-xl'}`}>
            <button
