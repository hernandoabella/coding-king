    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in Julia.',
...
println("Name: $name, Age: $age")`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: 'Understand Julia data types like Int, Float64, String, and Bool.',
        content: `integer = 10
floating = 3.14
string = "Julia"
boolean = true

println(typeof(integer), typeof(floating), typeof(string), typeof(boolean))`,
        output: `Int64 Float64 String Bool`
      },
      {
        id: 'functions',
        title: 'Functions',
        description: 'Learn how to define and call functions in Julia.',
