...
System.out.println("Name: " + name + ", Age: " + age);`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Java's data types like int, double, String, and boolean.",
...
System.out.println(
    ((Object)integer).getClass().getSimpleName() + " " +
    ((Object)floating).getClass().getSimpleName() + " " +
