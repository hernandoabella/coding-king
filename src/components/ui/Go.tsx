...
func main() {
    ...
    fmt.Printf("Name: %s, Age: %d\\n", name, age)
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Go's basic types like int, float64, string, and bool.",
        content: `package main
...
func main() {
    ...
    fmt.Printf("%T %T %T %T\\n", integer, floating, str, boolean)
}`,
        output: "int float64 string bool"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in Go using the const keyword.',
        content: `package main
