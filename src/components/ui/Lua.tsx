...
print("Name: " .. name .. ", Age: " .. age)`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: 'Understand Lua data types like number, string, boolean, and table.',
        content: `local num = 42       -- number
local str = "Lua"     -- string
local bool = true     -- boolean
local tbl = {1, 2, 3} -- table

print(type(num), type(str), type(bool), type(tbl))`,
        output: `number string boolean table`
      },
      {
        id: 'functions',
        title: 'Functions',
        description: 'Learn how to define and call functions in Lua.',
