...
console.log(\`Name: \${name}, Age: \${age}\`);`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand JavaScript's data types like number, string, boolean, and object.",
        content: `let integer = 10;
let floating = 3.14;
let string = "JavaScript";
let boolean = true;
console.log(typeof integer, typeof floating, typeof string, typeof boolean);`,
        output: "number number string boolean"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in JavaScript.',
        content: `const PI = 3.14159; // JavaScript constants cannot be reassigned
console.log(PI);`,
        output: "3.14159"
      }
    ],
