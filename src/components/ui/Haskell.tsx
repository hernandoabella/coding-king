...
const tutorialData = [
  {
    ...
    subtopics: [
      {
        ...
        description: 'Learn how to define and use bindings in Haskell.',
        content: `main = do
    let name = "Alice"
    let age = 25
    putStrLn ("Name: " ++ name ++ ", Age: " ++ show age)`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Haskell's basic types like Int, Float, String, and Bool.",
        content: `main = do
    let integer = 10 :: Int
    let floating = 3.14 :: Float
    let string = "Haskell" :: String
    let boolean = True :: Bool

    putStrLn (show (typeOf integer) ++ ", " ++
              show (typeOf floating) ++ ", " ++
              show (typeOf string) ++ ", " ++
              show (typeOf boolean))

-- typeOf requires Data.Typeable
import Data.Typeable (typeOf)`,
        output: "Int, Float, [Char], Bool"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in Haskell (top-level bindings).',
        content: `piValue :: Float
piValue = 3.14159
