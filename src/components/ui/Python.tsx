...
const Python = () => {
  ...
  const [visibleOneliners, setVisibleOneliners] = useState(
    INITIAL_VISIBLE_ONELINERS
  );
  ...
  const projects = [
    {
      name: "Mad Libs",
      difficulty: 1,
      icon: <FaBrain className="text-yellow-300 text-2xl" />,
      tutorial: "This is a Mad Libs tutorial...",
    },
    {
      name: "Guess the Number Game",
      difficulty: 2,
      icon: <FaHashtag className="text-green-300 text-2xl" />,
      tutorial: "This is a Guess the Number tutorial...",
    },
    {
      name: "Rock, Paper, Scissors",
      difficulty: 2,
      icon: <FaHandRock className="text-red-400 text-2xl" />,
      tutorial: "This is a Rock, Paper, Scissors tutorial...",
    },
    {
      name: "Hangman",
      difficulty: 3,
      icon: <FaUserSecret className="text-purple-300 text-2xl" />,
      tutorial: "This is a Hangman tutorial...",
    },
    {
      name: "Countdown Timer",
      difficulty: 3,
      icon: <FaStopwatch className="text-blue-400 text-2xl" />,
      tutorial: "This is a Countdown Timer tutorial...",
    },
    {
      name: "Password Generator",
      difficulty: 4,
      icon: <FaKey className="text-orange-300 text-2xl" />,
      tutorial: "This is a Password Generator tutorial...",
    },
    {
      name: "QR Code Encoder / Decoder",
      difficulty: 4,
      icon: <FaQrcode className="text-gray-300 text-2xl" />,
      tutorial: "This is a QR Code tutorial...",
    },
    {
      name: "Tic-Tac-Toe",
      difficulty: 5,
      icon: <FaGamepad className="text-pink-400 text-2xl" />,
      tutorial: "This is a Tic-Tac-Toe tutorial...",
    },
  ];
  ...
  const sections = [
    {
      ...
      subtopics: [
        ...
        },
        {
          ...
          content: <p>Python was created by Guido van Rossum in 1991.</p>,
        },
        {
          id: "why-use-python",
          title: "Why Use Python?",
          content: <p>Python is used in web development, data science...</p>,
        },
        {
    ...
    is_valid = True # Boolean`}
              ...
              <p>
                Use the <code>type()</code> function to check the data type:
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                You can take user input using the <code>input()</code> function:
              </p>
              <pre className="language-python">
                <code className="language-python">
    ...
    print("Hello, " + name)`}
              ...
              <p>
                By default, <code>input()</code> returns a string. Convert it if
                needed:
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Used for comparing values, returning <code>True</code> or{" "}
                <code>False</code>.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                We can use if-else statements inside other if-else statements.
              </p>
              <pre className="language-python">
                <code className="language-python">
                  {`age = 20
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Python 3.10 introduced the match-case statement, similar to
      ...
      subtopics: [
        {
          ...
          content: (
            <div>
              ...
              <p>
                The <code>for</code> loop is used to iterate over a sequence
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                The <code>while</code> loop executes as long as the condition is
                true.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Python provides <code>break</code>, <code>continue</code>, and{" "}
                <code>pass</code> for loop control.
              </p>
              <ul className="list-disc pl-5">
                ...
                <li>
                  <code>pass</code>: Does nothing (used as a placeholder).
                </li>
              </ul>
              <pre className="language-python">
                <code className="language-python">
      ...
      subtopics: [
        {
          ...
          content: (
            <div>
              ...
              <p>
                In Python, functions are defined using the <code>def</code>{" "}
                keyword.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>
                  <b>Positional Arguments</b> - Arguments passed in order.
                </li>
                <li>
                  <b>Keyword Arguments</b> - Arguments passed with a key-value
                  pair.
                </li>
                <li>
                  <b>Default Arguments</b> - Arguments with default values.
                </li>
                <li>
                  <b>Arbitrary Arguments</b> - Using <code>*args</code> and{" "}
                  <code>**kwargs</code>.
                </li>
              </ul>
              <pre className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Functions can return values using the <code>return</code>{" "}
                statement.
              </p>
              <pre className="language-python">
                <code className="language-python">
          ...
          content: (
            <div>
              ...
              <p>
                ...
                <code>len()</code>, <code>max()</code>, <code>min()</code>,{" "}
                <code>sum()</code>, <code>sorted()</code>.
              </p>
              <pre className="language-python">
                <code className="language-python">
                  {`numbers = [3, 1, 4, 1, 5]
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Modules can be imported using the <code>import</code> statement.
              </p>
              <pre className="language-python">
                <code className="language-python">
                  {`import math
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                A Python module is simply a file with a <code>.py</code>{" "}
                extension.
              </p>
              <pre className="language-python">
                <code className="language-python">
      ...
      subtopics: [
        {
          ...
          content: (
            <div>
              ...
              <p>
                Lists are ordered, mutable collections that allow duplicate
                elements.
              </p>
              <pre className="language-python">
                <code className="language-python">
          ...
          content: (
            <div>
              ...
              <ul className="list-disc pl-5">
                ...
                <li>
                  <code>insert()</code> - Inserts an element at a specific
                  index.
                </li>
                <li>
                  <code>remove()</code> - Removes a specified element.
                </li>
                <li>
                  <code>pop()</code> - Removes and returns the last element.
                </li>
                <li>
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Tuples are ordered, immutable collections that allow duplicate
                elements.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>
                  <code>count()</code> - Counts occurrences of a value.
                </li>
                <li>
                  <code>index()</code> - Returns the index of a value.
                </li>
              </ul>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Sets are unordered, mutable collections that do not allow
                duplicate elements.
              </p>
              <pre className="language-python">
                <code className="language-python">
      ...
      subtopics: [
        {
          ...
          content: (
            <div>
              ...
              <p>
                Dictionaries in Python are unordered collections of key-value
                pairs. They allow fast lookups and modifications.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <ul className="list-disc pl-5">
                <li>
                  <code>keys()</code> - Returns a view of all keys.
                </li>
                <li>
                  <code>values()</code> - Returns a view of all values.
                </li>
                <li>
                  <code>items()</code> - Returns key-value pairs as tuples.
                </li>
                <li>
                  <code>get()</code> - Safely gets a value (avoids KeyError).
                </li>
                <li>
                  <code>pop()</code> - Removes a key and returns its value.
                </li>
                <li>
                  <code>update()</code> - Merges another dictionary.
                </li>
              </ul>
              <pre className="language-python">
                <code className="language-python">
      ...
      subtopics: [
        {
          ...
          content: (
            <div>
              ...
              <p>
                File handling in Python allows you to create, read, update, and
                delete files.
              </p>
              <pre className="language-python">
                <code className="language-python">
              ...
              <table className="border-collapse border border-gray-400 w-full">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-gray-400 px-2 py-1">
                      Read (default mode, raises an error if file doesn’t exist)
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-400 px-2 py-1">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Use <code>read()</code>, <code>readline()</code>, or{" "}
                <code>readlines()</code> to read content.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Use <code>"w"</code> mode to write or <code>"a"</code> mode to
                append content.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Use <code>seek()</code> and <code>tell()</code> to manage file
                pointer position.
              </p>
              <pre className="language-python">
                <code className="language-python">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                Use <code>try-except</code> to handle missing files or
                permission errors.
              </p>
              <pre className="language-python">
                <code className="language-python">
          ...
          content: (
            <div>
              ...
              <p>
                ...
                gracefully and prevent your program from crashing. Python uses{" "}
                <code>try-except</code> blocks to catch and handle exceptions.
              </p>
              <pre className="language-python">
                <code className="language-python">
                  {`try:
              ...
              <table className="border-collapse border border-gray-400 w-full">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-400 px-2 py-1">
                      Raised when an operation is performed on an incorrect data
                      type.
                    </td>
                  </tr>
                  <tr>
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                You can catch multiple exceptions using multiple{" "}
                <code>except</code> blocks.
              </p>
              <pre className="language-python">
                <code className="language-python">
                  {`try:
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                The <code>finally</code> block executes code no matter what,
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                You can define your own exceptions by creating a custom class.
              </p>
              <pre className="language-python">
                <code className="language-python">
      ...
      subtopics: [
        {
          ...
          content: (
            <div>
              ...
              <p>
                Python has a built-in package manager called <code>pip</code>.
                You can use it to install external libraries from the Python
                Package Index (PyPI).
              </p>
              <pre className="language-bash">
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                The <code>requests</code> library allows you to send HTTP
                requests easily. First, install it:
              </p>
              <pre className="language-bash">
                <code className="language-bash">pip install requests</code>
              </pre>
        ...
        },
        {
          ...
          content: (
            <div>
              ...
              <p>
                A virtual environment helps keep dependencies separate between
                projects. Create one with:
              </p>
              <pre className="language-bash">
      ...
      subtopics: [
        {
          ...
          content: (
            <div>
              ...
              <p>
                SQLite is a lightweight, file-based database that comes built-in
                with Python.
              </p>
              <pre className="language-python">
                <code className="language-python">
    ...
    print("Connected to SQLite successfully!")`}
              ...
              <p>
                To connect to MySQL, you'll need the{" "}
                <code>mysql-connector-python</code> package.
              </p>
              <pre className="language-bash">
                <code className="language-bash">
    ...
    for row in rows:
        print(row)`}
              ...
              <h3 className="text-xl font-semibold mt-4">
                Executing SQL Queries with MySQL
              </h3>
              <pre className="language-python">
                <code className="language-python">
                  {`# Create a table
