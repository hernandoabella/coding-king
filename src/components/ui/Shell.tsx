    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in shell scripting.',
        content: `# Declaring and using variables
name="Alice"
echo "Hello, $name!"`,
        output: `Hello, Alice!`
      },
      {
        id: 'conditionals',
        title: 'Conditionals',
        description: 'Use if-else statements in shell scripts.',
        content: `# If-else example
num=10
if [ $num -gt 5 ]; then
  ...
  echo "Number is 5 or less"
      ...
      },
      {
        id: 'loops',
        title: 'Loops',
        description: 'Use for loops in shell scripts.',
        content: `# For loop example
for i in 1 2 3; do
  echo "Number $i"
done`,
        output: `Number 1
