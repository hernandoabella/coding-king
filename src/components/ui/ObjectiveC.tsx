    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in Objective-C.',
...
int main(int argc, const char * argv[]) {
    ...
    return 0;
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Objective-C data types like int, float, NSString, and BOOL.",
        content: `#import <Foundation/Foundation.h>
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        BOOL boolean = YES;
        NSLog(@"%d %f %@ %d", integer, floating, str, boolean);
    }
    return 0;
}`,
        output: "10 3.140000 Objective-C 1"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in Objective-C using #define and const.',
        content: `#import <Foundation/Foundation.h>
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        const int max = 100;
        NSLog(@"PI: %f, Max: %d", PI, max);
    }
    return 0;
}`,
        output: "PI: 3.141590, Max: 100"
      }
    ],
  },
];

const ObjectiveCTutorial = () => {
...
export default ObjectiveCTutorial;
