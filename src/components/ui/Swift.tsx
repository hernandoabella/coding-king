...
print("Name: \\(name), Age: \\(age)")`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Swift's basic data types like Int, Double, String, and Bool.",
        content: `let integer: Int = 10
let floating: Double = 3.14
let string: String = "Swift"
let boolean: Bool = true

print(integer, floating, string, boolean)`,
        output: "10 3.14 Swift true"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'In Swift, constants are declared using let instead of var.',
        content: `let PI: Double = 3.14159
