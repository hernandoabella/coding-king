    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to define and use variables in Clojure using def.',
...
(println (str "Name: " name ", Age: " age))`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Clojure's data types like integer, float, string, boolean, keyword, and list.",
        content: `(def integer 10)
(def floating 3.14)
(def string "Clojure")
(def boolean true)
(def keyword :ok)
...
(println integer floating string boolean keyword lst)`,
        output: "10 3.14 Clojure true :ok (1 2 3)"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Clojure does not have enforced constants, but you can use def with uppercase names by convention.',
        content: `(def PI 3.14159)
