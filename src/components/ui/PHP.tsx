    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in PHP.',
        content: `<?php
$name = "Alice";
$age = 25;
...
?>`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand PHP's data types like int, float, string, and boolean.",
        content: `<?php
$integer = 10;
$floating = 3.14;
$string = "PHP";
...
echo gettype($integer) . " " .
     ...
     gettype($boolean);
?>`,
        output: "integer double string boolean"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in PHP using define().',
        content: `<?php
define("PI", 3.14159);
echo PI;
?>`,
