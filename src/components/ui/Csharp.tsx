...
class Program
{
    static void Main()
    {
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand C# data types like int, double, string, and bool.",
        content: `using System;
...
class Program
{
    static void Main()
    {
        ...
        output: "System.Int32 System.Double System.String System.Boolean"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in C# using const.',
        content: `using System;
