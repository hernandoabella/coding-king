    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare variables in Elm using let expressions.',
...
main =
    ...
    name ++ " is " ++ String.fromInt(age) ++ " years old"`,
      ...
      },
      {
        id: 'functions',
        title: 'Functions',
        description: "Understand how to define and use functions in Elm.",
        content: `module Main exposing (..)
...
main =
    greet "Bob"`,
      ...
      },
      {
        id: 'types',
        title: 'Types',
        description: 'Learn about Elm types and type annotations.',
        content: `module Main exposing (..)
