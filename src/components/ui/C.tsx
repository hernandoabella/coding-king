...
int main() {
    ...
    return 0;
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand C's data types like int, float, char, and double.",
        content: `#include <stdio.h>
...
int main() {
    ...
    return 0;
        ...
        output: "int float char double"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in C using #define or const.',
        content: `#include <stdio.h>
