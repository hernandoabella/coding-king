    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in Elixir (all bindings are immutable).',
        content: `name = "Alice"
age = 25
...
IO.puts("Name: #{name}, Age: #{age}")`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Elixir's data types like integer, float, string, atom, and boolean.",
        content: `integer = 10
floating = 3.14
string = "Elixir"
atom = :ok
...
IO.puts(Enum.join([inspect(integer), inspect(floating), inspect(string), inspect(atom), inspect(boolean)], ", "))`,
        output: "10, 3.14, \"Elixir\", :ok, true"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in Elixir using module attributes.',
