    ...
    subtopics: [
      {
        id: 'variables',
        title: 'Variables',
        description: 'Learn how to declare and use variables in Dart.',
        content: `// Declaring variables in Dart
var name = "Alice";
int age = 25;
print("Name: \$name, Age: \$age");`,
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand Dart's data types like int, double, String, and bool.",
        content: `int integer = 10;
...
bool`
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in Dart.',
        content: `const double pi = 3.14159;
...
const DartTutorial = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto p-4 md:p-6 transition-all duration-300">
      ...
      {/* Main content */}
      <main
        className={`flex-1 p-6 rounded-2xl shadow-lg border overflow-y-auto max-h-[calc(100vh-8rem)] custom-scroll
          ${isDarkMode ? 'border-gray-700 bg-gray-900' : 'border-gray-200 bg-white'}`}
      >
        {/* Progress bar */}
