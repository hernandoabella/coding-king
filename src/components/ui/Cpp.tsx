...
int main() {
    ...
    return 0;
      ...
      },
      {
        id: 'data-types',
        title: 'Data Types',
        description: "Understand C++ data types like int, float, string, and bool.",
        content: `#include <iostream>
#include <typeinfo>
using namespace std;
...
int main() {
    ...
    cout << typeid(integer).name() << " "
         ...
         << typeid(str).name() << " "
         << typeid(boolean).name() << endl;
    return 0;
}`,
        output: "i f NSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE b"
      },
      {
        id: 'constants',
        title: 'Constants',
        description: 'Learn how to define constants in C++ using const or constexpr.',
        content: `#include <iostream>
using namespace std;
